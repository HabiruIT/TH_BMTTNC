...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_gen_keys.setGeometry(QtCore.QRect(440, 40, 201, 41))
        font = QtGui.QFont()
        ...
        self.txt_info.setGeometry(QtCore.QRect(180, 110, 591, 161))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.txt_info.setFont(font)
        self.txt_info.setObjectName("txt_info")
        self.txt_sign = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_sign.setGeometry(QtCore.QRect(180, 290, 591, 161))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.txt_sign.setFont(font)
        self.txt_sign.setObjectName("txt_sign")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(50, 290, 121, 31))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.label_3.setFont(font)
        self.label_3.setObjectName("label_3")
        self.btn_sign = QtWidgets.QPushButton(self.centralwidget)
        self.btn_sign.setGeometry(QtCore.QRect(210, 460, 93, 41))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.btn_sign.setFont(font)
        self.btn_sign.setObjectName("btn_sign")
        self.btn_verify = QtWidgets.QPushButton(self.centralwidget)
        self.btn_verify.setGeometry(QtCore.QRect(640, 460, 93, 41))
        font = QtGui.QFont()
        font.setPointSize(16)
